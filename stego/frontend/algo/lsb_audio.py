...
class AudioLSB:
    ...
    def embeded_message_audio(self, input, message, output):
        ...
        # Кодируем сообщение
        binary_message = self.text_to_bin(message) + '1111111111111110'
        mess_index = 0
        for ampl, _ in enumerate(audio_array):
...
if __name__ == '__main__':
    ...
    # Начальные данные
    input = '/home/yaroslav/infdef/steganography_with_ml/stego/frontend/algo/melodia.wav'
    message = 'хуй'*5000
    output = '/home/yaroslav/infdef/steganography_with_ml/stego/frontend/algo/melodia_output.wav'

    # Кодируем сообщение
    audio_lsb = AudioLSB()
    audio_lsb.embeded_message_audio(input, message, output)

    # Декодируем сообщение
    decoded_text = audio_lsb.decode_audio(output)
